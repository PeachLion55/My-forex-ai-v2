...
# TAB 2: Backtesting
# =========================================================
tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab8 = st.tabs(["Fundamentals", "Backtesting", "MT5 Performance Dashboard", "Psycology", "Manage My Strategy", "My Account", "Community Trade Ideas", "Tools"])
with tab2:
