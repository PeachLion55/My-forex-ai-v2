...
import streamlit as st
import os
import base64 # Make sure base64 is imported if not already

# =========================================================
# DYNAMIC GLOBAL HEADER
# Place this block at the top level of your script, before the main page routing.
# =========================================================

# --- This function must be defined globally earlier in your script ---
@st.cache_data
...
# 1. Central configuration for all pages
PAGE_CONFIG = {
...
# 2. Get the configuration for the currently selected page
current_page_key = st.session_state.get('current_page', 'account')
page_info = PAGE_CONFIG.get(current_page_key)

# Only render the header if the current page is found in the config
if page_info:
    # 3. Define all CSS styles (with slightly larger sizing)
    ...
    # 4. Prepare the dynamic parts of the header
    icon_html = ""
    ...
    # 6. Render the header and the divider
