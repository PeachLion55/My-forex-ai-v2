...
# PAGE CONFIG
# =========================================================
st.set_page_config(page_title="Forex Dashboard", layout="wide", initial_sidebar_state="collapsed")
...
econ_calendar_data = [
    ...
    {"Date": "2025-08-21", "Time": "13:00", "Currency": "USD", "Event": "Jackson Hole Symposium", "Actual": "", "Forecast": "", "Previous": "", "Impact": "High"},
...
🦹‍ 🦹‍ 🕒 🦹‍ 🕒 Stay aware of active trading sessions to trade when volatility is highest.
        ...
        st.title("🛠 Tools")
        st.markdown("Select a tool from the sidebar submenu to get started.")
    st.markdown('</div>', unsafe_allow_html=True)
...
def show_psychology():
    ...
    if progress >= 1.0:
        ...
        _ta_update_xp(100) # Bonus XP for completion
    st.markdown('</div>', unsafe_allow_html=True)
