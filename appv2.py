...
# =========================================================
# CUSTOM SIDEBAR CSS (Replaced and Corrected)
# =========================================================
st.markdown(
    """
    <style>
        /* --- Main Sidebar Styling (from your code) --- */
        ...
        /* Targets the secondary buttons used for inactive navigation items */
        section[data-testid="stSidebar"] div.stButton > button {
            width: 100%; /* Use 100% to fill the column nicely */
            ...
            /* CORRECTED GRADIENT: Starts black on the left, fades to your teal color on the right */
            background: linear-gradient(to right, rgba(0, 0, 0, 0.7), rgba(88, 179, 177, 0.7)) !important;
        }

        /* --- Active (Primary) Button Styling --- */
        /* Targets the primary button, which you use for the active page */
        /* NOTE: The "st-emotion-cache-..." class is generated by Streamlit and can change with updates */
        section[data-testid="stSidebar"] div.stButton > button.st-emotion-cache-19rxjzo {
            border-color: rgba(88, 179, 177, 1.0) !important;
             /* Active gradient is more prominent: black to solid teal */
            background: linear-gradient(to right, black, rgba(88, 179, 177, 1.0)) !important;
        }

        /* --- Hover Effect Styling (for all buttons) --- */
        section[data-testid="stSidebar"] div.stButton > button:hover {
            transform: scale(1.02); /* Subtle zoom effect */
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3) !important;
            color: #f0f0f0 !important;
            cursor: pointer !important;
            /* Make the gradient more opaque on hover */
            background: linear-gradient(to right, rgba(0, 0, 0, 1.0), rgba(88, 179, 177, 1.0)) !important;
        }

        /* --- Responsive Styling for Smaller Screens (from your code) --- */
