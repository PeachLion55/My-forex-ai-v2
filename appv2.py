...
journal_dtypes = {
    'Date': 'datetime64[ns]', 'Symbol': 'string', 'Weekly Bias': 'string',
    'Daily Bias': 'string', '4H Structure': 'string', '1H Structure': 'string',
    'Positive Correlated Pair & Bias': 'string', 'Potential Entry Points': 'string',
    '5min/15min Setup?': 'string', 'Entry Conditions': 'string', 'Planned R:R': 'string',
    'News Filter': 'string', 'Alerts': 'string', 'Concerns': 'string',
    'Emotions': 'string', 'Confluence Score 1-7': 'int64', 'Outcome / R:R Realised': 'string',
    'Notes/Journal': 'string', 'Entry Price': 'float64', 'Stop Loss Price': 'float64',
    'Take Profit Price': 'float64', 'Lots': 'float64', 'Tags': 'string'
}
...
# Define placeholder functions for XP and streak updates
